      ...
      <el-tabs v-model="activeName" class="demo-tabs">
        <el-tab-pane label="Lista de registros" name="first">
          ...
          >
            ...
            <el-table-column prop="ruc_es" label="RUC" width="130px" />
            <el-table-column prop="razon_social_es" label="RAZON SOCIAL"/>
            <el-table-column :align="'center'" width="100px" prop="flota" label="FLOTA"/>
            <el-table-column :align="'center'" width="100px" prop="activo_es" label="ACTIVO"/>
            <el-table-column fixed="right" :align="'center'" width="150px" label="Opciones">
...
import FormPersona from '@/components/share/personas/FormPersona.vue'

const modelRequest = new Resource('listaservicios')
const emit = defineEmits(['closeServicio'])
