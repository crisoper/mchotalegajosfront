      ...
      <el-tabs v-model="activeName" class="demo-tabs">
        <el-tab-pane label="Lista de registros" name="first">
          ...
          >
            ...
            <el-table-column prop="ruc" label="RUC" width="130px" />
...
import FormEmpresa from '@/views/admin/empresas/components/FormEmpresa.vue'

const modelRequest = new Resource('listaempresas')
const emit = defineEmits(['closeEmpresa'])
