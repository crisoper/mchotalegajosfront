          ...
          <el-dropdown trigger="click" @command="handleActionsOpciones">
            ...
            <template #dropdown>
              <el-dropdown-menu ref="dropdown">
                <el-dropdown-item
                  :command="{ action: 'ADD' }"
                  :disabled="isActionDisabled('maestros.cargos.crear')" 
                >
                ...
                <!-- <el-dropdown-item
                  ...
                  :disabled="isActionDisabled('maestros.cargos.exportar')"
                > 
                  <span>
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item
                    ...
                    :disabled="isActionDisabled('maestros.cargos.actualizar')"
                  >
                    <span>
                  ...
                  <el-dropdown-item
                    ...
                    :disabled="isActionDisabled('maestros.cargos.eliminar')"
                  >
                    <span>
...
const dataResource = new Resource('administracion/cargos')
...
export default {
  ...
  methods: {
    ...
    addItem() {
      ...
      this.titleForm = 'Registrar cargo'
    ...
    editItem(item) {
      // console.log(item)
      this.titleForm = 'Modificar cargo'
      this.openDialogCreate = true;
      this.$nextTick(() => {
    ...
    handleRowActions(commandData) {
      ...
      if (action === 'EDIT' && validPermision('maestros.cargos.actualizar')) {
        this.editItem(item)
      } else if (action === 'DELETE' && validPermision('maestros.cargos.eliminar')) {
    ...
    handleActionsOpciones(command) {
      ...
      if (action === 'ADD' && validPermision('maestros.cargos.crear')) {
        this.addItem()
      } else if (action === 'EXPORT' && validPermision('maestros.cargos.exportar')) {
        this.exportarDatos()
      } else {
        ElNotification({message: 'Usted no tiene permiso para realizar esta acción', type: 'info' })
      }
