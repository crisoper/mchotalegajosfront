<template>
  <el-card shadow="never" v-loading="loading">
    <el-form ref="createObject" :model="model" :rules="rules" label-position="top">
      ...
      <el-form-item prop="siglas" label="Siglas">
        <el-input v-model="model.siglas" placeholder="Siglas" @keydown.enter.prevent="submitForm(createObject)"/>
      </el-form-item>
...
const modelRequest = new Resource('administracion/areas')
...
const rules = reactive({
  ...
  siglas: [{ required: true, message: 'Campo obligatorio', trigger: 'blur' }],
