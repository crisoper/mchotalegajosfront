<template>
  <div v-loading="loadingData">
    ...
    >
      ...
      <el-table-column :align="'center'" width="120px" prop="siglas" label="  SIGLAS"/>
          ...
          <el-dropdown trigger="click" @command="handleActionsOpciones">
            ...
            <template #dropdown>
              <el-dropdown-menu ref="dropdown">
                <el-dropdown-item
                  :command="{ action: 'ADD' }"
                  :disabled="isActionDisabled('maestros.areas.crear')" 
                >
                ...
                <!-- <el-dropdown-item
                  ...
                  :disabled="isActionDisabled('maestros.areas.exportar')"
                > 
                  <span>
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item
                    ...
                    :disabled="isActionDisabled('maestros.areas.actualizar')"
                  >
                    <span>
                  ...
                  <el-dropdown-item
                    ...
                    :disabled="isActionDisabled('maestros.areas.eliminar')"
                  >
                    <span>
...
const dataResource = new Resource('administracion/areas')
...
export default {
  ...
  methods: {
    ...
    handleRowActions(commandData) {
      ...
      if (action === 'EDIT' && validPermision('maestros.areas.actualizar')) {
        this.editItem(item)
      } else if (action === 'DELETE' && validPermision('maestros.areas.eliminar')) {
    ...
    handleActionsOpciones(command) {
      ...
      if (action === 'ADD' && validPermision('maestros.areas.crear')) {
        this.addItem()
      } else if (action === 'EXPORT' && validPermision('maestros.areas.exportar')) {
        this.exportarDatos()
      } else {
        ElNotification({message: 'Usted no tiene permiso para realizar esta acción', type: 'info' })
      }
